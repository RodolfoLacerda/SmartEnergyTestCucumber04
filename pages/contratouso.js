var acesso = {
    with: function () {
        return this
            ...
            .click('@menuContratos')
            .pause(2000)
            .waitForElementVisible('@adicionarContrato', 1000)
    ...
    informarModalidade: function () {
        ...
        browser
            ...
            .waitForElementVisible('@informarmodalidade', 2000)
            .click('@informarmodalidade')
...
module.exports = {
    ...
    elements: {
        ...
        selecionarTipoContrato: '#select-use_contract_type\\.id_use_contract_type',
        ...
        selecionarEmpresa: '#select-company\\.id_company',
        informarEmpresaCaja: '#menu-company\\.id_company > div.MuiPaper-root.MuiMenu-paper.MuiPaper-elevation8.MuiPopover-paper.MuiPaper-rounded > ul > li:nth-child(1)',
        ...
        selecionarAgente: '#select-energy_dealer\\.id_company',
        informarAgente: '#menu-energy_dealer\\.id_company > div.MuiPaper-root.MuiMenu-paper.MuiPaper-elevation8.MuiPopover-paper.MuiPaper-rounded > ul > li:nth-child(1)',
        pontoConexao: '#id_connectionpoint',
        inicioPosto: '#id_peakbegintime',
        fimPosto: '#id_endbegintime',
        numeroContrato: '#id_usagecontractnumber',
        selecionarTensaoNominal: '#select-rated_voltage\\.id_rated_voltage',
        informarTensaoNominal: '#menu-rated_voltage\\.id_rated_voltage > div.MuiPaper-root.MuiMenu-paper.MuiPaper-elevation8.MuiPopover-paper.MuiPaper-rounded > ul > li:nth-child(3)',
        ...
        selecionarModalidade: '#select-energy_distributor\\.hourly_tax_modality',
        informarmodalidade: '#menu-energy_distributor\\.hourly_tax_modality > div.MuiPaper-root.MuiMenu-paper.MuiPaper-elevation8.MuiPopover-paper.MuiPaper-rounded > ul > li:nth-child(2)',
